...
import { FaSquareEnvelope, FaPaperPlane, FaMessage } from "react-icons/fa6";
import { FaMastodon, FaXTwitter, FaGithub } from "react-icons/fa6";
        ...
        >
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div
                className={`glassish p-8 rounded-xl shadow-2xl transition-shadow duration-500`}
              >
                <h3 className="text-2xl font-semibold mb-8 text-white flex items-center">
                  <FaMessage className={`w-6 h-6 mr-3 ${PRIMARY_COLOR}`} /> Send
                  a Message
                </h3>
              ...
              <div className="space-y-8">
                ...
                >
                  ...
                  <ul className="space-y-4 text-gray-400">
                    <li className="flex items-center">
                      <FaSquareEnvelope
                        className={`w-5 h-5 mr-4 ${PRIMARY_COLOR} flex-shrink-0`}
                      />
                ...
                >
                  ...
                  <div className="flex space-x-6">
                    <a
                      href="https://github.com/ARMSX2"
                      target="_blank"
                      rel="noopener noreferrer"
                      aria-label="GitHub"
                      className={`${PRIMARY_COLOR} hover:text-[#a09afa] transition-colors`}
                    >
